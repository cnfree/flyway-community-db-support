...
public class OpenGaussTable extends Table<OpenGaussDatabase, OpenGaussSchema> {

    OpenGaussTable(JdbcTemplate jdbcTemplate, OpenGaussDatabase database, OpenGaussSchema schema, String name) {
